...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if(dropdown){
  const select = dropdown.querySelector('.ai-chat__dropdawn-selest');
  const list = dropdown.querySelector('ul');

  // Клик или повторный клик по селектору
  select.addEventListener('click', (e) => {
    dropdown.classList.toggle('_active');
  });

  // Убираем _active при уходе курсора
  dropdown.addEventListener('mouseleave', () => {
    dropdown.classList.remove('_active');
  });

  // Клик по одному из пунктов списка
  list.querySelectorAll('li').forEach(li => {
    li.addEventListener('click', () => {
      ...
      // Заменяем содержимое в select
      select.innerHTML = '';
      select.appendChild(img);
      const span = document.createElement('span');
      span.textContent = text;
	  document.querySelectorAll('._name-ai').forEach(element => {
		element.querySelector('span').innerHTML = text
		element.querySelector('img').src = img.src
	  });
...
function setFullHeightMinusHeader() {
  const header = document.querySelector('header');
  const blocks = document.querySelectorAll('.js-full');
...
document.addEventListener('DOMContentLoaded', setFullHeightMinusHeader);

// Пересчёт при изменении размера окна
window.addEventListener('resize', setFullHeightMinusHeader);


document.addEventListener('DOMContentLoaded', () => {
  const tabs = document.querySelectorAll('.right-home__tabs [data-click]');
  const blocks = document.querySelectorAll('.right-home__wp');
  ...
  tabs.forEach(tab => {
    tab.addEventListener('click', () => {
      ...
      // добавляем активный класс вкладке
      tab.classList.add('_active');
	  tab.closest('.home').classList.remove('_hide');

      // получаем значение data-click
      const target = tab.dataset.click.toLowerCase(); // bets или results

      // активируем соответствующий блок
      const targetBlock = document.querySelector(`.right-home__wp._${target}`);
...
function initCounters() {
  ...
  counters.forEach(el => {
    ...
    if (el.dataset.odInit) return;
    el.dataset.odInit = 'true';
    ...
    const decPart = ((value - intPart) * 100).toFixed(0);
...
// Функция обновления всех счётчиков
...
// setInterval(() => {
// 	document.querySelectorAll('.counter')[0].dataset.value = "110500.25";
// 	document.querySelectorAll('.counter')[1].dataset.value = "219500.25";
// 	document.querySelectorAll('.counter')[2].dataset.value = "113500.25";
// 	document.querySelectorAll('.counter')[3].dataset.value = "110550.55";
// 	document.querySelectorAll('.counter')[4].dataset.value = "110510.05";
// updateCounters()
// console.log(123)
// }, 4000);
...
function initRightHomeTimers() {
	const timers = document.querySelectorAll('.right-home__timer[data-timer]');
	...
	timers.forEach(timer => {
		...
		const minutes = parseInt(timer.dataset.timer, 10);
		if (isNaN(minutes) || minutes <= 0) return;

		let totalSeconds = minutes * 60;

		const span = timer.querySelector('span');
		const parent = timer.closest('.right-home__element');
		...
		function formatTime(totalSeconds) {
			...
			if (hours > 0 || days > 0) result += `${hours.toString().padStart(2, '0')} hr `;
			if (mins > 0 || hours > 0 || days > 0) result += `${mins.toString().padStart(2, '0')} min `;
			result += `${secs.toString().padStart(2, '0')} sec`;

			return result.trim();
		}

		function updateTimer() {
			span.textContent = formatTime(totalSeconds);

			if (totalSeconds <= 0) {
				clearInterval(interval);
				if (parent) parent.classList.add('_blur');
				return;
			}
...
// первый запуск при загрузке страницы
document.addEventListener('DOMContentLoaded', initRightHomeTimers);
...
function delAnim(){
let rightHomeElement = document.getElementsByClassName('right-home__element');
for (let index = 0; index < rightHomeElement.length; index++) {
	const element = rightHomeElement[index];
	element.classList.remove('_animation')
	
}
}
// setTimeout(() => {
// 	const list = document.querySelector('.right-home__wp._bets');
// 	const list2 = document.querySelector('.right-home__wp._results');
// const newEl = document.createElement('div');
// newEl.className = 'right-home__element';
// newEl.innerHTML = `<div class="right-home__element _animation">
// 								<div class="right-home__blur">
// 									<img src="img/cec.png" alt>
// 									<span>The event has ended</span>
// 									<p>please check the "Result" tab</p>
// 								</div>
// 								<div class="right-home__top">BTC > 110K in 10 min</div>
// 								<div class="right-home__timer" data-timer="1"><img src="img/Bold/Time/Clock Square.png" alt>
// 									<span></span></div>
...
// 										<li>
// 											<div><img src="img/gpt-c.png" alt> GPT-5 </div>
// 											<div><img src="img/ues.png" alt></div>

// 											<!-- если нужно с анимацией  -->
// 											<div>
// 												<div class="counter" data-value="150">
...
// 											<!-- если нужно без анимациии  -->
// 											<!-- <div>$250</div> -->
// 											<!-- если нужно без анимациии  -->
// 										</li>
// 										<li>
// 											<div><img src="img/deepsick-c.png" alt> DeepSeek </div>
// 											<div><img src="img/no.png" alt></div>
// 											<div>
// 												<div class="counter" data-value="250">
// 													<span class="symbol">$</span>
// 													<span class="odometer">0</span>
// 													<span style="display: none;" class="decimal-od"></span>
// 												</div>
...
// 										</li>
// 										<li>
// 											<div><img src="img/clause-c.png" alt> Claude </div>
// 											<div><img src="img/ues.png" alt></div>
// 											<div>
// 												<div class="counter" data-value="250">
// 													<span class="symbol">$</span>
...
// 										</li>
// 										<li>
// 											<div><img src="img/grock-c.png" alt> Grok </div>
// 											<div><img src="img/no.png" alt></div>
// 											<div>
// 												<div class="counter" data-value="250">
// 													<span class="symbol">$</span>
...
// 										</li>
// 										<li>
// 											<div><img src="img/gemeni-c.png" alt> Gemini </div>
// 											<div><img src="img/ues.png" alt></div>
// 											<div>
// 												<div class="counter" data-value="250">
// 													<span class="symbol">$</span>
...
// 										</li>
// 										<li>
// 											<div><img src="img/quen-c.png" alt> Qwen </div>
// 											<div><img src="img/no.png" alt></div>
// 											<div>
// 												<div class="counter" data-value="250">
// 													<span class="symbol">$</span>
...
// 								</div>
// 							</div>`;
// list.insertAdjacentElement('afterbegin', newEl);
...
function initTextAnimation(speed = 20) {
	const elements = document.querySelectorAll('[data-anim-text]');

	elements.forEach(el => {
		// если уже анимирован — пропускаем
		if (el.dataset.animated) return;
		el.dataset.animated = 'true';

		const fullText = el.dataset.animText.trim();
		el.textContent = ''; // очистим перед началом
